// server.js (com Otimização de Puppeteer para Render)
...
const client = new Client({
  ...
  puppeteer: {
    headless: true,
    // --- ARGUMENTOS OTIMIZADOS PARA AMBIENTES COM POUCA MEMÓRIA (RENDER) ---
    args: [
      '--no-sandbox',
      ...
      '--no-zygote',
      '--disable-gpu',
      '--disable-extensions' // Adicionado para economizar recursos
    ]
  }
});
